...
module.exports = (function (_super) {
    ...
    function Squick(options) {
        ...
        this.setupDust();
        this.on("finish", function () { return _this.emit("posts-ended"); });
        options.views
            .on("data", function (f) {
            if (f.isBuffer()) {
    ...
    Squick.prototype.setupDust = function () {
        ...
        var options = {
            all_posts: new Promise(function (resolve, reject) {
                _this.once("error", reject);
                _this.once("posts-ended", function () { return resolve(_this.posts); });
            })
        };
    ...
    Squick.prototype.getPost = function (name) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            _this.once("posts-ended", function () { return reject(error); });
        });
    };
