...
module.exports = (function (_super) {
    ...
    function Squick(content, views) {
        ...
        views.on("data", function (f) {
            concatFile(f, function (f, c) { return _this.addTemplate(f, c); });
        }).on("end", function () { return _this.emit("templates-ended"); });
    }
    ...
    Squick.prototype.startRender = function (post, template) {
        ...
        return this.getTemplate(template)
            .then(function () { return new DustStream(template, { post: post }); });
    };
    return Squick;
})(stream_1.Readable);
